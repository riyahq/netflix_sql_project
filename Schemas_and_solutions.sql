...
SELECT MAX(CAST(REGEXP_SUBSTR(duration,'[0-9]+')AS INTEGER)) AS longest_movie_duration FROM netflix 
	WHERE type='Movie';
...
SELECT 
	EXTRACT(YEAR FROM TO_DATE(date_added,'Month DD, YYYY')) as year,COUNT(*) as year_content,
